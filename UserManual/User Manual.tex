...
\break
 ...
 \textbf{Version} & 0.0.3 \\
 \hline
 \textbf{Document Status} & Third Version - contains screenshots for different pages \\
 \hline
 \end{tabu}
...
\centering
 ...
 \hline 
 & & & \\
 0.0.3& 23 July 2015 &  Third draft containing  & Rendani Dau, \\ & & screenshots of the & Elana Kuun, \\ & & of different paged & Semaka Malapane, \\ & & and their functionality &  Antonia Michael \\ & & & Isabel Nel \\   [1ex]  
 \hline
 \end{tabular}
\end{table}
...
\begin{figure}[H]
  \centering
    \includegraphics[width=1.0\textwidth]{../UserManual/limitExeedSignUp.png}
...
\begin{figure}[H]
  \centering
    \includegraphics[width=1.0\textwidth]{../UserManual/signIn.png}
    \caption{Sign In page - Type the appropriate information in the textboxes and click submit to sign in} 
\end{figure}

\begin{figure}[H]
  \centering
    \includegraphics[width=1.0\textwidth]{../UserManual/ForgotPass.png}
    \caption{Forgot password page} 
\end{figure}

\begin{figure}[H]
  \centering
    \includegraphics[width=1.0\textwidth]{../UserManual/pleaseWaitForPass.png}
    \caption{After submitting the form} 
\end{figure}

\begin{figure}[H]
  \centering
    \includegraphics[width=1.0\textwidth]{../UserManual/emailSentForPass.png}
    \caption{After submitting the form - notified about email sent} 
\end{figure}

\begin{figure}[H]
  \centering
    \includegraphics[width=1.0\textwidth]{../UserManual/emailForPass.png}
    \caption{The actual email that the system sent - follow the provided url to change password} 
\end{figure}

\begin{figure}[H]
  \centering
    \includegraphics[width=1.0\textwidth]{../UserManual/newPassForPass.png}
    \caption{The url sent via the email leads to this page - fill in the textboxes and new password is set} 
\end{figure}
...
\begin{figure}[H]
  \centering
    \includegraphics[width=1.0\textwidth]{../UserManual/searchMenu.png}
...
\begin{figure}[H]
  \centering
    \includegraphics[width=1.0\textwidth]{../UserManual/searchCheese.png}
    \caption{The menu page - Can be navigated via the search bar as illustrated} 
\end{figure}

\begin{figure}[H]
  \centering
    \includegraphics[width=1.0\textwidth]{../UserManual/catMenu.png}
...
\begin{figure}[H]
  \centering
    \includegraphics[width=1.0\textwidth]{../UserManual/tunaAdd.png}
    \caption{Menu page - Adding a meal to your plate } 
\end{figure}

\begin{figure}[H]
  \centering
    \includegraphics[width=1.0\textwidth]{../UserManual/onPlate.png}
...
\begin{figure}[H]
  \centering
    \includegraphics[width=1.0\textwidth]{../UserManual/editProfile.png}
...
\begin{figure}[H]
  \centering
    \includegraphics[width=1.0\textwidth]{../UserManual/limitExeeds.png}
...
\begin{figure}[H]
  \centering
    \includegraphics[width=1.0\textwidth]{../UserManual/viewProfile.png}
...
\begin{figure}[H]
  \centering
    \includegraphics[width=1.0\textwidth]{../UserManual/changePassDontMatch.png}
...
\begin{figure}[H]
  \centering
    \includegraphics[width=1.0\textwidth]{../UserManual/assignRoles.png}
...
\begin{figure}[H]
  \centering
    \includegraphics[width=1.0\textwidth]{../UserManual/canteenName.png}
    \caption{The admin settings page - superuser can change the canteen name} 
\end{figure}

\begin{figure}[H]
  \centering
    \includegraphics[width=1.0\textwidth]{../UserManual/coverImage.png}
    \caption{The admin settings page - superuser can change the cover image} 
\end{figure}
