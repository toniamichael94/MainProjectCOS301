...
\begin{figure}[H]
  \centering
    \includegraphics[width=1.0\textwidth]{screenshots/pleaseWaitForPass.png}
...
\begin{figure}[H]
  \centering
    \includegraphics[width=1.0\textwidth]{screenshots/emailForPass.png}
...
\begin{figure}[H]
  \centering
    \includegraphics[width=1.0\textwidth]{screenshots/tunaAdd.png}
