...
\subsubsection{None technical strengths}
\subsubsection{What makes you want to do the project}
The project poses an interesting challenge and I am curious about how these types of systems work. This project is also very similar to the type of systems I want to develop in the future. I enjoy web development and the other various technologies that can be used in this project. 
