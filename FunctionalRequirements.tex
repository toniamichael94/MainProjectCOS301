...
\begin{figure}[h!]
  \centering
    \includegraphics[width=0.85\textwidth]{CMSUseCase} 
\end{figure}

\item Place Order Use Case\\
\begin{figure}[h!]
  \centering
    \includegraphics[width=0.85\textwidth]{placeOrder} 
\end{figure}

\item Check product availability activity diagram\\
\begin{figure}[h!]
  \centering
    \includegraphics[width=0.85\textwidth]{checkProductAvailability} 
\end{figure}
...
\begin{figure}[h!]
  \centering
    \includegraphics[width=0.85\textwidth]{checkLimit} 
\end{figure}
...
\begin{figure}[h!]
  \centering
    \includegraphics[width=0.85\textwidth]{manageProfile} 
\end{figure}

\item Generate favourites activity diagram\\
\begin{figure}[h!]
  \centering
    \includegraphics[width=0.85\textwidth]{generateFavourites} 
\end{figure}

\item Edit profile use case\\
\begin{figure}[h!]
  \centering
    \includegraphics[width=0.85\textwidth]{editProfile} 
\end{figure}

\item Change password activity diagram\\
\begin{figure}[h!]
  \centering
    \includegraphics[width=0.85\textwidth]{changePassword} 
\end{figure}
...
\begin{figure}[h!]
  \centering
    \includegraphics[width=0.85\textwidth]{changeEmail} 
\end{figure}
...
\begin{figure}[h!]
  \centering
    \includegraphics[width=0.85\textwidth]{changeLimit} 
\end{figure}
