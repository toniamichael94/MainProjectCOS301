...
%%now begin document
 ...
 \textbf{Version} & 0.0.3 \\
 \hline
 \textbf{Document Status} & Third Version - contains tests for  inventory, placedOrders, registration and authentication controller, and models  \\
 \hline
 \end{tabu}
...
\subsubsection{Register Module - authentication.client.controller.js}
...
\subsubsection{Register and Authentication Module - user.server.model.js}
...
Test Case 8: should show an error when the email does not contain an @ sign and the email is in correct format: Pass\\
 ...
 \subsubsection{Inventory Module - inventory.server.model.js}
...
\subsubsection{ Register and Authentication module- test.server.routes.js}
