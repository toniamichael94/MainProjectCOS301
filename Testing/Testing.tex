...
%%now begin document
 ...
 \textbf{Version} & 0.0.5\\
 \hline
 \textbf{Document Status} & Fifth Version - contains added tests for cashier client controller, finance client controller, orders client controller and updates on the other tests  \\
 \hline
 \end{tabu}
...
Pre Conditions: The user facilitating the orders is the cashier and is hence on the process orders page that is only accessable to the cashier\\
...
Pre Conditions: The user facilitating the orders is the finance manager and is hence on the process orders page that is only accessable to the finance manager. \\ The employee ID has been entered and is valid\\
