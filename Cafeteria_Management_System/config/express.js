...
module.exports = function(db) {
        //Config = mongoose.model(config.getGlobbedFiles('./app/models/config.server.model.js')); //mongoose.model('./app/models/config.server.model.js');
    ...
    /*  Config.findOne({
          ...
          if (!theme) {
              app.locals.cssFiles = config.getCSSAssets('default');
  ...
  /*       }
            ...
            app.locals.cssFiles = config.getCSSAssets(theme);
