...
\begin{enumerate}
	...
	\item Integrability. Integrability refers to how seperate components of the system work together. Different components of the cafeteria should work together correctly. One component should not cause other components
