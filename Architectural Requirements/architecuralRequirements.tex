...
Listed below are the nice to have quality requirements related to the Cafeteria Management System, these requirements are not considered as crutical but are considered as desireble. \\
...
\begin{enumerate}
	...
	\item Flexibility. Flexibility refers to the ability of a system to respond in a time and cost efficient manner to internal or extarnal changes that affects the quality of its service. The system should be able to increase or sustain the quality of its service when responding to these changes.
